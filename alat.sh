...
echo "\033[37;1m[] AUTHOR :  Muhammad Abdul Wahid                            
[]"|lolcat
echo "\033[35;1m[] W A    :   082338404546                           []"|lolcat
echo "\033[36;1m[] NO HP  :   082338404546                            []"|lolcat
...
echo $blue"PASSWORDNYA ( wahid ) ITU GAN"|lolcat
...
echo "GOOD BY"|lolcat
echo"SALAM WONG NGANJUK"|lolcat
exit
logout
fi